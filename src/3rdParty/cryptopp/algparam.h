...
#endif
		{
#pragma warning(disable: 4297) // SIFOON: Disable warning: "function assumed not to throw an exception but does" https://msdn.microsoft.com/en-us/library/84e2zwhh.aspx
